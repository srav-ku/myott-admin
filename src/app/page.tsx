  ...
  return (
    <div className="min-h-screen grid place-items-center bg-bg text-white p-4">
      ...
      <div className="w-full max-w-md relative">
          ...
          {user && !isAdmin ? (
            <div className="text-center space-y-4">
              ...
              <button 
                ...
                className="text-sm text-text-dim hover:text-white underline"
              >
                Try another account
              </button>
            </div>
        ...
        <div className="mt-12 flex items-center justify-center gap-4 text-xs text-text-dim uppercase tracking-widest">
          <span>Secure</span>
